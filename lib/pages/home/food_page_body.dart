...
import 'package:first_project/widgets/icon_and_text_widgets.dart';
...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        //Slider section
        GetBuilder<PopularProdsController>(builder: (popularProducts){
        ...
        //Recommended Food
        GetBuilder<RecommendedProdsController>(builder: (recommendedProduct){
